...
window.Modernizr = function(e, t, n) {
    ...
    function D(e, t) {
        for (var r in e) if (f[e[r]] !== n) return t == "pfx" ? e[r] : !0;
        return !1;
    }
    function P(e, t, r) {
        for (var i in e) {
    ...
    function H(e, t, n) {
        var r = e.charAt(0).toUpperCase() + e.substr(1), i = (e + " " + v.join(r + " ") + r).split(" ");
    ...
    function j() {
        i.input = function(n) {
            ...
            for (var r = 0, i, s, u, a = e.length; r < a; r++) l.setAttribute("type", s = e[r]), i = l.type !== "text", i && (l.value = c, l.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(s) && l.style.WebkitAppearance !== n ? (o.appendChild(l), u = t.defaultView, i = u.getComputedStyle && u.getComputedStyle(l, null).WebkitAppearance !== "textfield" && l.offsetHeight !== 0, o.removeChild(l)) : /^(search|tel)$/.test(s) || (/^(url|email)$/.test(s) ? i = l.checkValidity && l.checkValidity() === !1 : /^color$/.test(s) ? (o.appendChild(l), o.offsetWidth, i = l.value != c, o.removeChild(l)) : i = l.value != c)), b[e[r]] = !!i;
            return b;
        }("search tel url email datetime date month week time datetime-local number range color".split(" "));
    }
    var r = "2.5.3", i = {}, s = !0, o = t.documentElement, u = "modernizr", a = t.createElement(u), f = a.style, l = t.createElement("input"), c = ":)", h = {}.toString, p = " -webkit- -moz- -o- -ms- ".split(" "), d = "Webkit Moz O ms", v = d.split(" "), m = d.toLowerCase().split(" "), g = {
        ...
        return s = [ "&#173;", "<style>", e, "</style>" ].join(""), l.id = u, h.innerHTML += s, h.appendChild(l), c || (h.style.background = "", o.appendChild(h)), a = n(l, e), c ? l.parentNode.removeChild(l) : h.parentNode.removeChild(h), !!a;
    }, N = function(t) {
    ...
    var B = function(n, r) {
        ...
        T(s, function(n, r) {
            ...
            i.touch = "ontouchstart" in e || e.DocumentTouch && t instanceof DocumentTouch || (f.touch && f.touch.offsetTop) === 9, i.csstransforms3d = (f.csstransforms3d && f.csstransforms3d.offsetLeft) === 9 && f.csstransforms3d.offsetHeight === 3, i.generatedcontent = (f.generatedcontent && f.generatedcontent.offsetHeight) >= 1, i.fontface = /src/i.test(u) && u.indexOf(r.split(" ")[0]) === 0;
        }, o, r);
    }([ '@font-face {font-family:"font";src:url("https://")}', [ "@media (", p.join("touch-enabled),("), u, ")", "{#touch{top:9px;position:absolute}}" ].join(""), [ "@media (", p.join("transform-3d),("), u, ")", "{#csstransforms3d{left:9px;position:absolute;height:3px;}}" ].join(""), [ '#generatedcontent:after{content:"', c, '";visibility:hidden}' ].join("") ], [ "fontface", "touch", "csstransforms3d", "generatedcontent" ]);
    y.flexbox = function() {
        return H("flexOrder");
    }, y["flexbox-legacy"] = function() {
        ...
        try {
            var r = t.createElement("canvas"), i;
            i = !(!e.WebGLRenderingContext || !r.getContext("experimental-webgl") && !r.getContext("webgl")), r = n;
        } catch (s) {
            i = !1;
        }
        return i;
        ...
        for (var t = -1, n = v.length; ++t < n; ) if (e[v[t] + "WebSocket"]) return !0;
    ...
    for (var F in y) L(y, F) && (x = F.toLowerCase(), i[x] = y[F](), E.push((i[x] ? "" : "no-") + x));
    return i.input || j(), i.addTest = function(e, t) {
        if (typeof e == "object") for (var r in e) L(e, r) && i.addTest(r, e[r]); else {
            e = e.toLowerCase();
            if (i[e] !== n) return i;
            t = typeof t == "function" ? t() : t, o.className += " " + (t ? "" : "no-") + e, i[e] = t;
        }
        return i;
