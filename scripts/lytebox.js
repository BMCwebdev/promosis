...
Lytebox.prototype.initialize = function() {
	...
	var oOuterContainer = this.doc.createElement('div');
		...
		if (this.roundedBorder) {
			oOuterContainer.style.MozBorderRadius = '';
			oOuterContainer.style.borderRadius = '';
		}
	...
	var oTopContainer = this.doc.createElement('div');
		...
		if (this.roundedBorder) {
			oTopContainer.style.MozBorderRadius = '';
			oTopContainer.style.borderRadius = '';
		}
	...
	var oBottomContainer = this.doc.createElement('div');
		...
		if (this.roundedBorder) {
			oBottomContainer.style.MozBorderRadius = '';
			oBottomContainer.style.borderRadius = '';
		}
...
Lytebox.prototype.fixBottomPadding = function() {
	if (!((this.ieVersion == 7 || this.ieVersion == 8 || this.ieVersion == 9) && this.doc.compatMode == 'BackCompat') && this.ieVersion != 6) {
		...
		this.doc.$('lbOuterContainer').style.paddingBottom = (offsetHeight + 1) + 'px';
	}
};
